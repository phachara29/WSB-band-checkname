function redirectToPage() {
  ...
  if (isNearby(userCoordinates, specifiedCoordinates)) {
    ...
    if (selectedUrl) {
      ...
      // Use specified coordinates (10.454143429867239, 99.23227715846424) if no URL is found
      var specifiedCoordinatesUrl = 'https://www.google.com/maps/@10.454143429867239,99.23227715846424,214m/data=!3m1!1e3?entry=ttu';
...
function getCurrentCoordinates() {
  // Example: return { lat: 10.454143429867239, lng: 99.23227715846424 };
...
function isNearby(userCoordinates, specifiedCoordinates) {
  ...
  var lon1 = deg2rad(userCoordinates.lng);
  var lat2 = deg2rad(specifiedCoordinates.lat);
  var lon2 = deg2rad(specifiedCoordinates.lng);
